export default function AboutLobbora() {
    return (
        <div className="bg-background-light dark:bg-background-dark text-[#0d141b] dark:text-white font-display overflow-x-hidden">
            <main className="layout-container flex flex-col items-center">
                {/* Hero Section */}
                    ...
                    <div className="group bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300">
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            ...
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">What is Learning OS?</h2>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                                    Learning OS is a comprehensive ecosystem designed for managing knowledge in the digital age. We provide the essential tools to organize, track, and master your learning journey amidst a cluttered digital world. Think of it as the central nervous system for everything you learn, read, and want to achieve.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="group bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300">
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            <div className="size-12 rounded-xl bg-purple-50 dark:bg-purple-900/30 flex items-center justify-center shrink-0">
                                <span className="material-icons-outlined text-purple-600 text-3xl">lightbulb</span>
                            </div>
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Why We Built Learning OS</h2>
                    ...
                    <div className="group bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300">
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            <div className="size-12 rounded-xl bg-orange-50 dark:bg-orange-900/30 flex items-center justify-center shrink-0">
                                <span className="material-icons-outlined text-orange-600 text-3xl">groups</span>
                            </div>
                            <div className="flex-1">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3 p-4 rounded-lg bg-background-light dark:bg-background-dark/50">
                                        <span className="material-icons-outlined text-primary">business_center</span>
                                    ...
                                    <div className="flex items-center gap-3 p-4 rounded-lg bg-background-light dark:bg-background-dark/50">
                                        <span className="material-icons-outlined text-primary">domain</span>
