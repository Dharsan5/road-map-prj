        ...
        <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {[
                    ...
                    <article key={index} className="group relative flex flex-col sm:flex-row bg-card-light dark:bg-card-dark rounded-2xl p-5 gap-6 border border-gray-100 dark:border-slate-700 shadow-soft hover:shadow-lg hover:border-blue-200 dark:hover:border-blue-900/50 transition-all duration-300">
